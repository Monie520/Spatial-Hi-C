...
5. Create configuration file for Higashi running using scripts [create_json_and_pickle_GPU.py](https://github.com/Monie520/Spatial-Hi-C/blob/main/1.preprocess/create_json_and_pickle_GPU.py).
