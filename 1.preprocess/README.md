...
5. Prepare configuration file for Higashi running by [pre_higashi_GPU_3.sh](https://github.com/Monie520/Spatial-Hi-C/blob/main/1.preprocess/scripts_50/pre_higashi_GPU_3.sh). This allows us to perform embedding and spot annotation.
6. Single spot A/B compartment score is calculated using Higashi by [Higashi_h_500kb.ipynb](https://github.com/Monie520/Spatial-Hi-C/blob/main/1.preprocess/Higashi_h_500kb.ipynb). This allows us to perform embedding and spot annotation.
